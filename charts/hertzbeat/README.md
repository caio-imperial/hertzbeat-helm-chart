...
| **External Database**                 |                                                                                                                                                                                                                 |                 |
| `database.external.host`              | External PostgreSQL host. Leave empty to use internal database. Set a value to use external database.                                                                                                           | `""`            |
| `database.external.port`              | External PostgreSQL port                                                                                                                                                                                        | `5432`          |
| `database.external.username`         | External PostgreSQL username                                                                                                                                                                                   | `root`          |
| `database.external.password`         | External PostgreSQL password (use either this or existingSecret)                                                                                                                                                | `""`            |
| `database.external.existingSecret`    | Kubernetes Secret name containing password. Secret must have a key named `password` or `postgresql-password`.                                                                                                  | `""`            |
| `database.external.database`          | External PostgreSQL database name                                                                                                                                                                               | `hertzbeat`     |
| **TSDB**                              |                                                                                                                                                                                                                 |                 |
